...
/** @defgroup ETH_Duplex_Mode 
  * @{
  */ 
#define ETH_Mode_FullDuplex       ((uint16_t)0x00000800)
#define ETH_Mode_HalfDuplex       ((uint16_t)0x00000000)
...
uint32_t ETH_Init1(ETH_InitTypeDef* ETH_InitStruct, u16 PHYAddress);
